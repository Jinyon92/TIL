...
- 소포트웨어 요소는 <strong>확장에는 열려</strong> 있으나 <strong>변경에는 닫혀</strong> 있어야 한다.
...
```java
MemberRepository m = new MemoryMemberRepository(); //구체화를 의존해서는 안된다
```
